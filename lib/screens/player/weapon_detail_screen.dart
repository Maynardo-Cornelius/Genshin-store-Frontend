  ...
  Future<void> _buy() async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        backgroundColor: result['transaction_id'] != null ? Colors.green : Colors.red,
      ),
    );
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(weapon.weaponName, style: const TextStyle(color: Colors.white)),
      ),
            ...
            SizedBox(
              ...
              child: weapon.image != null
                  ? CachedNetworkImage(
                      ...
                      fit: BoxFit.cover,
                      errorWidget: (_, __, ___) => const Icon(Icons.shield, size: 100, color: Colors.white24),
                    )
                  : const Center(child: Icon(Icons.shield, size: 100, color: Colors.white24)),
            ),
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(weapon.description, style: const TextStyle(color: Colors.white70, fontSize: 14, height: 1.5)),
                    ...
                    children: [
                      Expanded(
                        child: Container(
                          ...
                          child: Column(
                            children: [
                              const Text('Harga', style: TextStyle(color: Colors.white54, fontSize: 12)),
                  ...
                  // Quantity selector
                  const Text('Jumlah', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
                  const SizedBox(height: 8),
                  Row(
                    children: [
                      IconButton(
                      ...
                      IconButton(
                        onPressed: _quantity < weapon.stock ? () => setState(() => _quantity++) : null,
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      child: _isBuying
                          ...
                          : Text(
                              weapon.stock == 0 ? 'Stok Habis' : 'Beli Sekarang',
